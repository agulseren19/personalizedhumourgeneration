...
export default function CAHPage() {
  ...
  const tabs = [
    ...
    { id: 'analytics', label: 'Your Learning', icon: '📊' },
    { id: 'personas', label: 'AI Comedians', icon: '🎭' }
  ];

  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-indigo-900 pt-32">
      ...
      {/* Features Banner */}
      <div className="bg-gradient-to-r from-purple-600/20 to-indigo-600/20 border-t border-white/10 mt-12">
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              <div className="text-3xl mb-2">☁️</div>
              <h4 className="font-semibold text-white mb-1">AWS Knowledge Base</h4>
              <p className="text-sm text-gray-300">Vector embeddings and semantic search</p>
            </div>
          </div>
        </div>
      </div>
